...
public abstract class StressBase extends Activity{
	...
	public Button mClearSetMaxBtn = null;
	 ...
	 *  
	 */
	public void setDefaultBtnId(int startid, int stopid, int exitid, int setmaxid, int clearsetmaxid) {
		...
		if (clearsetmaxid != 0) {
			mClearSetMaxBtn = (Button) findViewById(clearsetmaxid);
			mClearSetMaxBtn.setOnClickListener(new OnClickListener() {
				public void onClick(View v) {
					mMaxTestCount = 0;
					updateMaxTV();
					onSetClearMaxClick();
	...
	public void updateBtnState() {
		...
		if (mClearSetMaxBtn != null)
			mClearSetMaxBtn.setEnabled(!isRunning);
	}
	...
	public abstract	void onSetClearMaxClick();
