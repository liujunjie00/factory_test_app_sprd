...
public class PsensorAutoTestActivity extends BaseActivity{
    ...
    private static final String TAG = "PsensorAutoTestActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        diplaySensorData(0);
        initSensor();
        mPHandler.sendEmptyMessageDelayed(STOP_TEST, 2000);
    }
