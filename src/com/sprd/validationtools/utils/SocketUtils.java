...
public class SocketUtils {
    ...
    public static LogControlAidl logctl = new LogControlAidl();
...
//            ops.write(getBytes(cmd));
    ...
    public static synchronized String sendCmdByAidl(String socketName, String strcmd) {
        String result = null;
        final String cmd = strcmd + "\0";
        if(logctl != null) {
            Log.d(TAG, "logctl not null");
            result = logctl.sendCmd(socketName, cmd);
        }
