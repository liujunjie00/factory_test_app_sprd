...
public class MMI2TestItemList extends com.sprd.validationtools.modules.TestItemList {
    private static final String TAG = "MMI2TestItemList";
    ...
    private static final String[] FILTER_CLASS_NAMES = {
		...
		//	TestInfoMainActivity2.class.getName(),
...
//            GpsTestActivity.class.getName(),
    ...
    private static MMI2TestItemList mTestItemListInstance = null;

    public static com.sprd.validationtools.modules.TestItemList getInstance(Context context) {
        if (mTestItemListInstance == null) {
        	mTestItemListInstance = new MMI2TestItemList(context);
        }
        return mTestItemListInstance;
    }

    private MMI2TestItemList(Context context) {
        super(context);
    }
