...
public class TestInfoMainActivity2 extends BaseActivity implements OnClickListener {
    private final static String TAG = "TestInfoMainActivity2";
        ...
        public void handleMessage(Message msg) {
            ...
            case GET_TESTR: {
                 EngSqlite engSqlite = EngSqlite
                        .getInstance(TestInfoMainActivity2.this); 
            ...
            AsyncTask<Void, Void, Bitmap> mQRCodeTask = new AsyncTask<Void, Void, Bitmap>() {
                ...
                protected Bitmap doInBackground(Void... params) {
                    ...
                    String qrtext = mTestInfoQRCode
                            .getTestInfoQRCode(TestInfoMainActivity2.this);
                    int width = TestInfoMainActivity2.this.getResources()
                            .getDimensionPixelSize(R.dimen.qrcode_bitmap_width);
                    int height = TestInfoMainActivity2.this
                            .getResources()
        ...
        mWifiTestUtil = new WifiTestUtil(mWifiManager) {
            ...
            public void wifiStateChange(int newState) {
                ...
                case WifiManager.WIFI_STATE_ENABLED:
                    String macAddress = getMacAddress(TestInfoMainActivity2.this);
    ...
    private void setTxtInfo() {
        ...
        AsyncTask<Void, Void, String> mWifiTask = new AsyncTask<Void, Void, String>() {
            ...
            protected String doInBackground(Void... params) {
                WifiManager wifiManager = (WifiManager) getSystemService(TestInfoMainActivity2.this.WIFI_SERVICE);
                WifiTestUtil wifiTestUtil = new WifiTestUtil(wifiManager);
                String macAddress = wifiTestUtil
                        .getMacAddress(TestInfoMainActivity2.this);
                if (TextUtils.isEmpty(macAddress)) {
