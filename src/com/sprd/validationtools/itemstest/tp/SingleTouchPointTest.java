...
public class SingleTouchPointTest extends BaseActivity {
    ...
    private Handler mSingleTouchHandler = new Handler() {
        @Override
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Const.isAutoTestMode()) {
            mSingleTouchHandler.sendEmptyMessageDelayed(STOP_TEST, 2000);
        }
    }
    ...
    protected void onDestroy() {
        if (mSingleTouchHandler != null) {
            mSingleTouchHandler.removeCallbacksAndMessages(null);
        }
        super.onDestroy();
    }
