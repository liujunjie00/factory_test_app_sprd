...
public class RedLightTest extends BaseActivity {
    ...
    private void setBackground() {
        ...
        mResult = PhaseCheckParse.getInstance().writeLedlightSwitch(7, 1);
        Log.d(TAG, "startTestWork RedLightTest res="+mResult);
    }
    ...
    public static boolean isSupport(Context context) {
        if (!Const.IS_SUPPORT_LED_TEST && !FileUtils.fileIsExists(Const.LED_RED_PATH)) {
            return false;
        }
        return true;
    }
