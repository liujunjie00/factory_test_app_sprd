...
public class BlueLightTest extends BaseActivity {
    ...
    private void setBackground() {
        ...
        mResult = PhaseCheckParse.getInstance().writeLedlightSwitch(8, 1);
        Log.d(TAG, "startTestWork BlueLightTest res="+mResult);
    }
    ...
    public static boolean isSupport(Context context) {
        if (!Const.IS_SUPPORT_LED_TEST && !FileUtils.fileIsExists(Const.LED_BLUE_PATH)) {
            return false;
        }
        return true;
    }
