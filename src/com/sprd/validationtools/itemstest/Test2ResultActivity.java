...
public class Test2ResultActivity extends Activity {
    private static final String TAG = "Test2ResultActivity";
    private Context mContext;
    public TextView mTestResultView;
    private MMI2EngSqlite mEngSqlite;
    private String mBit;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mContext = this;
        mEngSqlite = MMI2EngSqlite.getInstance(mContext);
        mListView = (ListView) findViewById(R.id.listview_layout);
        ListAdapter listAdapter = new ListAdapter(mContext,
                mEngSqlite.queryData(MMI2TestItemList.getInstance(
                        Test2ResultActivity.this).getTestItemList()));
		...
		mResetBtn = (Button)findViewById(R.id.test_result_reset);
		mResetBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
				...
				PhaseCheckParse.getInstance().writeStationTested("MMI2");//unTest
				PhaseCheckParse.getInstance().writeStationFail("MMI2");//
			//	finish();
			}
		});		
    }
