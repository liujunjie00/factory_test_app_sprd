...
public class MMI2TestActivity extends Activity {
    private static final String TAG = "MMI2TestActivity";
...
//    private ListView mListViewItem;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mEngSqlite = MMI2EngSqlite.getInstance(this);
    ...
    private void initAdapter() {
        TestItem item = null;
        MMI2EngSqlite engSqlite = MMI2EngSqlite.getInstance(MMI2TestActivity.this);
        if (engSqlite == null) {
            return;
        }
        mItemsListView.addAll(MMI2TestItemList.getInstance(
                MMI2TestActivity.this).getTestItemList());
/*         TestItem testResult = new TestItem("TestResult",
    ...
    private class ListItemClickListener implements OnItemClickListener {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position,
            ...
            intent.setClassName(MMI2TestActivity.this,
