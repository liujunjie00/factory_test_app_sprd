...
public class FrontSecondaryCameraTestActivity extends BaseActivity implements
    ...
    private static final String TAKE_IMAGE_NAME = "frontsec_backphoto.jpg";
    ...
    public static boolean isSupport(Context context) {
        ...
        Log.d(TAG, "FrontSecondaryCameraTestActivity numberOfCameras="
                    + numberOfCameras + ",cam3type=" + cam3type);
         if (numberOfCameras <= 2) {
            return false;
        }
        /*SPRD bug 759782 : Change filter*/
        return "front_blur".equals(cam3type) || "front_sbs".equals(cam3type);
    }
}
